...
final class Version20201124111815 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE sf_user (id VARCHAR(256) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('INSERT INTO sf_user (id, roles) SELECT DISTINCT owner, \'["ROLE_USER"]\' FROM short_urls;');
